...
func (umc *UserMetadataCreate) SetFirstName(s string) *UserMetadataCreate {
	umc.mutation.SetFirstName(s)
	return umc
}

// SetLastName sets the "last_name" field.
func (umc *UserMetadataCreate) SetLastName(s string) *UserMetadataCreate {
	umc.mutation.SetLastName(s)
	return umc
}

// SetGender sets the "gender" field.
func (umc *UserMetadataCreate) SetGender(b bool) *UserMetadataCreate {
	umc.mutation.SetGender(b)
	return umc
}
...
func (umc *UserMetadataCreate) check() error {
	if _, ok := umc.mutation.FirstName(); !ok {
		return &ValidationError{Name: "first_name", err: errors.New(`ent: missing required field "UserMetadata.first_name"`)}
	}
	if _, ok := umc.mutation.LastName(); !ok {
		return &ValidationError{Name: "last_name", err: errors.New(`ent: missing required field "UserMetadata.last_name"`)}
	}
...
func (umc *UserMetadataCreate) createSpec() (*UserMetadata, *sqlgraph.CreateSpec) {
	...
	if value, ok := umc.mutation.FirstName(); ok {
	...
	if value, ok := umc.mutation.LastName(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
