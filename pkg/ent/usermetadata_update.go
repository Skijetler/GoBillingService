...
func (umu *UserMetadataUpdate) SetFirstName(s string) *UserMetadataUpdate {
	umu.mutation.SetFirstName(s)
	return umu
}

// SetLastName sets the "last_name" field.
func (umu *UserMetadataUpdate) SetLastName(s string) *UserMetadataUpdate {
	umu.mutation.SetLastName(s)
	return umu
}

// SetGender sets the "gender" field.
func (umu *UserMetadataUpdate) SetGender(b bool) *UserMetadataUpdate {
	umu.mutation.SetGender(b)
	return umu
}
...
func (umu *UserMetadataUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := umu.mutation.FirstName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: usermetadata.FieldFirstName,
		})
	}
	if value, ok := umu.mutation.LastName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: usermetadata.FieldLastName,
		})
	}
...
// SetFirstName sets the "first_name" field.
func (umuo *UserMetadataUpdateOne) SetFirstName(s string) *UserMetadataUpdateOne {
	umuo.mutation.SetFirstName(s)
	return umuo
}

// SetLastName sets the "last_name" field.
func (umuo *UserMetadataUpdateOne) SetLastName(s string) *UserMetadataUpdateOne {
	umuo.mutation.SetLastName(s)
	return umuo
}

// SetGender sets the "gender" field.
func (umuo *UserMetadataUpdateOne) SetGender(b bool) *UserMetadataUpdateOne {
	umuo.mutation.SetGender(b)
	return umuo
}
...
func (umuo *UserMetadataUpdateOne) sqlSave(ctx context.Context) (_node *UserMetadata, err error) {
	...
	if value, ok := umuo.mutation.FirstName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: usermetadata.FieldFirstName,
	...
	if value, ok := umuo.mutation.LastName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: usermetadata.FieldLastName,
