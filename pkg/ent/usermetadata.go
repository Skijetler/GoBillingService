...
func (*UserMetadata) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case usermetadata.FieldFirstName, usermetadata.FieldLastName:
	...
	for i := range columns {
		...
		case usermetadata.FieldFirstName:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				um.FirstName = value.String
			}
		case usermetadata.FieldLastName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field last_name", values[i])
			} else if value.Valid {
				um.LastName = value.String
			}
		case usermetadata.FieldGender:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field gender", values[i])
			} else if value.Valid {
				um.Gender = value.Bool
			}
...
func (um *UserMetadata) String() string {
	...
	builder.WriteString(um.FirstName)
	builder.WriteString(", ")
	builder.WriteString("last_name=")
	builder.WriteString(um.LastName)
	builder.WriteString(", ")
